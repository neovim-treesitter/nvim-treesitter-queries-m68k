# nvim-treesitter-queries-m68k

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-m68k/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-m68k/actions/workflows/validate.yml)

Neovim tree-sitter queries for **m68k**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-m68k",
...
- [ ] Changes are scoped to `m68k` — do not include files for other languages
